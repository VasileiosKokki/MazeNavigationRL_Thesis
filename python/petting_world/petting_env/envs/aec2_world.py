...
class CustomActionMaskedEnvironment(AECEnv):
    ...
    def get_obs(self):
        observation = {
            "guard1": np.array((self.prisoner_location, self.guard1_location, self.guard2_location)),
            "guard2": np.array((self.prisoner_location, self.guard2_location, self.guard1_location)),
        }
